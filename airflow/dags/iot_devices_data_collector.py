...
check_documents_existence_op = ShortCircuitOperator(
    task_id="check_documents_existence", python_callable=check_documents_existence, dag=dag
)
...
(
    check_documents_existence_op
    >> extract_and_merge_data_op
    >> check_data_in_landing_zone_op
    >> deletion_of_extracted_data_op
)
