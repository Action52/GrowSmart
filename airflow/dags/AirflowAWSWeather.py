...
def combine_data():
    ...
    city_data = [
        extract_data_Barcelona(),
        extract_data_Girona(),
        extract_data_Madrid(),
        extract_data_Tarragona(),
        extract_data_Lleida(),
    ]
...
def upload_to_s3():
    ...
    for city_data in all_data.values():
        ...
        row += [
            city_name,
            city_data["daily"]["temperature_2m_max"][0],
            city_data["daily"]["temperature_2m_min"][0],
            city_data["daily"]["rain_sum"][0],
            city_data["daily"]["showers_sum"][0],
            city_data["daily"]["snowfall_sum"][0],
            city_data["daily"]["precipitation_probability_max"][0],
        ]
        writer.writerow(row)
